...
const UpdateRecipeForm = ({ onSubmit, userId, isOpen, handleClose, recipeData }) => {
    ...
    useEffect(() => {
        if (recipeData) {
          setRecipe({
            ...
            ingredients: recipeData.ingredients.join(', ') || "Ingredient 1, Ingredient 2, Ingredient 3",
            instructions: recipeData.instructions.join(', ') || "Step 1, Step 2, Step 3",
